...
```{r}
ig_icon <- "&#xf16d"
my_caption <- glue("Fontes: National Centers for Environmental Information; Climatempo. <br>Gráfico por Bianca Muniz (<span style='font-family:\"Font Awesome 6 Brands\";'>{ig_icon};</span> biancmuniz)")
